    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='newsentries', null=True, verbose_name='Categories', to='multilingual_news.Category', blank=True)),
                ('content', cms.models.fields.PlaceholderField(related_name='multilingual_news_contents', slotname=b'multilingual_news_content', blank=True, editable=False, to='cms.Placeholder', null=True)),
                ('excerpt', cms.models.fields.PlaceholderField(related_name='multilingual_news_excerpts', slotname=b'multilingual_news_excerpt', blank=True, editable=False, to='cms.Placeholder', null=True)),
